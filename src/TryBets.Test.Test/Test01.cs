...
namespace TryBets.Test.Test
{
    ...
    public class Test01 : IClassFixture<WebApplicationFactory<TryBets.MatchesProgram.Program>>
    {
        public HttpClient _client;
        public Test01(WebApplicationFactory<TryBets.MatchesProgram.Program> factory)
        {
        ...
        [Trait("Category", "1. Teste microsserviço TryBets.Matches")]
