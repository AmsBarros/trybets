...
public class ErrorMessage
{
    ...
    public class Test03 : IClassFixture<WebApplicationFactory<TryBets.BetsProgram.Program>>
    {
        public HttpClient _client;
        public Test03(WebApplicationFactory<TryBets.BetsProgram.Program> factory)
        {
        ...
        [Trait("Category", "3. Teste microsserviço TryBets.Bets")]
        ...
        [InlineData("/bet", 3, 15, 250, "maria@trybets.com", "Team not found")]
        [InlineData("/bet", 3, 4, 250, "maria@trybets.com", "Team is not in this match")]
        [InlineData("/bet", 300, 1, 250, "maria@trybets.com", "Match not found")]
        ...
        [Trait("Category", "3. Teste microsserviço TryBets.Bets")]
        [Theory(DisplayName = "Será validado que é possível consultar uma aposta")]
        [InlineData("/bet", 100, "maria@trybets.com", "Bet not found")]
        [InlineData("/bet", 101, "maria@trybets.com","Bet not found")]
        [InlineData("/bet", 102, "maria@trybets.com", "Bet not found")]
